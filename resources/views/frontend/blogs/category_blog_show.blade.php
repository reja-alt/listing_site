                        ...
                        <div class="blog-box-layout2 mg-b-30">
                            <div class="item-img">
                                <a href="single-blog.html">
                                    <img src="{{asset('uploads/blog')}}/{{$category_blog->image}}" alt="Blog">
                                </a>
                            </div>
                            <div class="item-content">
                                <h3><a href="{{  route('single.blog',$category_blog->slug) }}">{{ $category_blog->title }}</a></h3>
                                <ul class="blog-entry-meta">
                                    <li><i class="far fa-calendar-alt"></i>{{ \Carbon\Carbon::parse($category_blog->created_at)->format('j F, Y')}}</li>
                                    <li><i class="fas fa-user"></i><a href="#">RadiusTheme</a></li>
                                    <li><i class="fas fa-comments"></i>(0)</li>
                                </ul>
                                <p>{{ str_limit($category_blog->details,'150','....') }}</p>
                            </div>    
                        </div>
                    </div>
                    @endforeach
