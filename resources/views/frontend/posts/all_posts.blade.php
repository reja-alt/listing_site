                                        ...
                                        <div class="grid-view-layout1">
                                            ...
                                            <div class="product-box-layout1 top-rated-grid">
                                                <div class="item-img">
                                                    ...
                                                    @foreach(json_decode($all_post->thumbnail) as $key => $image)
                                                    @if($key == 0)
                                                ...
                                                <div class="item-content">
                                                    <h3 class="item-title"><a href="{{ route('user_post.show',$all_post->slug) }}">{{ $all_post->title }}</a><span>{{ $all_post->condition_type }}</span></h3>
                                                    <ul class="entry-meta">
                                                        <li><i class="far fa-clock"></i>{{ \Carbon\Carbon::parse($all_post->created_at)->diffForHumans()}}</li>
                                                        <li><i class="fas fa-map-marker-alt"></i>{{ $all_post->address }}</li>
                                                    </ul>
