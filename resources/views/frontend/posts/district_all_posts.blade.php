                                        ...
                                        <div class="grid-view-layout1">
                                            ...
                                            <div class="product-box-layout1 top-rated-grid">
                                                <div class="item-img">
                                                    ...
                                                    @foreach(json_decode($district_post->thumbnail) as $key => $image)
                                                    @if($key == 0)
                                                ...
                                                <div class="item-content">
                                                    <h3 class="item-title"><a href="{{ route('user_post.show',$district_post->slug) }}">{{ $district_post->title }}</a><span>{{ $district_post->condition_type }}</span></h3>
                                                    <ul class="entry-meta">
                                                        <li><i class="far fa-clock"></i>{{ \Carbon\Carbon::parse($district_post->created_at)->diffForHumans()}}</li>
                                                        <li><i class="fas fa-map-marker-alt"></i>{{ $district_post->address }}</li>
                                                    </ul>
