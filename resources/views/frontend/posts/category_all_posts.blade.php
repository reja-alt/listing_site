                    ...
                    <div class="col-12">
                        <div class="breadcrumbs-area">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('all.post') }}">All Adds</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                                        ...
                                                        <div id="category{{ $key+1 }}" class="collapse" data-parent="#accordion2">
                                                            <div class="card-body">
                                                                ...
                                                                <ul class="sub-list">
                                                                    ...
                                                                    <a href="{{ route('subcategory.post',$subcategory->slug) }}"> {{ $subcategory->name }}</a>
                                                                    @endforeach
                                                                </ul>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="grid-view-layout1">
                                            ...
                                            <div class="product-box-layout1 top-rated-grid">
                                                <div class="item-img">
                                                    ...
                                                    @foreach(json_decode($category_post->thumbnail) as $key => $image)
                                                    @if($key == 0)
                                                ...
                                                <div class="item-content">
                                                    <h3 class="item-title"><a href="{{ route('user_post.show',$category_post->slug) }}">{{ $category_post->title }}</a><span>{{ $category_post->condition_type }}</span></h3>
                                                    <ul class="entry-meta">
                                                        <li><i class="far fa-clock"></i>{{ \Carbon\Carbon::parse($category_post->created_at)->diffForHumans()}}</li>
                                                        <li><i class="fas fa-map-marker-alt"></i>{{ $category_post->address }}</li>
                                                    </ul>
